...
type Match struct {
	...
	Agent1SubmissionID  *string     `json:"agent1SubmissionId,omitempty" db:"agent1_submission_id"`
	Agent2SubmissionID  *string     `json:"agent2SubmissionId,omitempty" db:"agent2_submission_id"`
